# the list of functions that disk.frame can handle
SUMM_FNS = c("sum",  "mean", "var", "sd", "min",  "max", "median", "n", "length", "any", "all", "n_distinct", "quantile", "IQF")
BASIC_OPS = c("/", "*", "+", "-", "!")
