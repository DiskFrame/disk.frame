...
As you can see the the 303 files are converted to a `disk.frame` in about ~3mins, this actually alot faster than Spark.
...
[ am available for Machine Learning/Data Science/R/Python/Julia consulting! [Email me](mailto:dzj@analytixware.com)