...
plot(
  map_dbl(
    list(firstm, secondm, thirdm, fourthm, fifthm), ~.x$auc), type="b", ylim = c(0.4,0.9), main="AUC vs number of variables",ylab="AUC",xlab="Number of Variables")
abline(h = 0.7, lty = 2)
